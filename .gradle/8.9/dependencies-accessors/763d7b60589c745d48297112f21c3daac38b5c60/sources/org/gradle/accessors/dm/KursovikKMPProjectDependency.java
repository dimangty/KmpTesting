...
@NonNullApi
public class KursovikKMPProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KursovikKMPProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
